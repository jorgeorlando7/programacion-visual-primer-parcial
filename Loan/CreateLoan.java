...
class CreateLoan {
    ...
    public static String getLoanNum() {
        ...
        // asks user to input customer loan number
    ...
    public static String getLastName() {
        ...
        try {
            // asks user to input customer last name
    ...
    public static double getPrimeIntRate() {
        ...
        // asks user to enter prime interest rate, then validates input
        try {
    ...
    public static int getTerm() {
        ...
        // asks user to enter loan term, then validates input
        try {
    ...
    public void getLoanDetails() {
        ...
        for (int x = 0; x < loanDetails.length; x++) {
            ...
            // stores details through the array object
